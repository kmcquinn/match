...
def plot(cmdfile_name, outfile_name, plot_name):
	figsize=(8, 8)
	subsize = 0.25
	...
	ax5 = plot_Hist(fig, age_arr, sfr_arr, subx3, suby2, subsize, '(f) Star Formation Rate', 'age (Gyr)','SFR','steps', sfr_low, sfr_high)
