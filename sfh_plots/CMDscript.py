...
dat = np.genfromtxt('/Users/zilishen/core-cusp/'+plot_title+'/'+plot_title+'_' + bluefilter+'_'+redfilter+'.gst')
...
fdat = np.loadtxt('10210_UGC1281/fake')
...
plotname = 'CMD_'+plot_title+'.png'

plt.savefig(plot_title+'/'+plotname,dpi=300)
